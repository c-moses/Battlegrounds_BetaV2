class BGLayer6 extends BGBaseLayer // Battle of Tisy
{
	...
	override void CheckCaptureRadius()
    {
        ...
        array<string> playersWithin25m = new array<string>();
        array<string> playersWithin50m = new array<string>();
        array<string> playersWithin75m = new array<string>();
        ...
        for (int i = 0; i < playersInRadius.Count(); i++)
        {
            ...
            {
                playersWithin25m.Insert(player.GetIdentity().GetName());
                currencyAmount = 100;
            }
            ...
            {
                playersWithin75m.Insert(player.GetIdentity().GetName());
                currencyAmount = 20;
            }
            else
            {
